...
const Footer = () => {
  ...
  return (
    <footer className="bg-charcoal dark:bg-background text-white dark:text-foreground">
      {/* CTA Section */}
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="glass rounded-3xl p-8 lg:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" className="btn-glass px-8 py-4 text-lg font-semibold">
          ...
          <div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-card-foreground">1-800-CALL-PRO</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary" />
                <span className="text-card-foreground">info@callcenterpro.com</span>
              </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <span className="text-muted-foreground text-sm">Certified & Compliant</span>
              <div className="flex space-x-3">
                <div className="px-3 py-1 bg-muted rounded text-xs font-medium text-foreground">SOC 2</div>
                <div className="px-3 py-1 bg-muted rounded text-xs font-medium text-foreground">HIPAA</div>
                <div className="px-3 py-1 bg-muted rounded text-xs font-medium text-foreground">PCI DSS</div>
              </div>
            </div>
          </div>
        </div>
